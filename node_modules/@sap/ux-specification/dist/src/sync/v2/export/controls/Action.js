...
exports.FooterAction = exports.ToolBarAction = exports.Action = exports.buildIntentBasedActionId = void 0;
...
const getActionButtonId = (baseId, _idBreadcrumbs, breadcrumbs) => {
    ...
    return `${baseId}action::${common_1.convertActionKeyToStableId(actionId).replace(':2f', '::')}`;
};
/**
...
const buildIntentBasedActionId = (baseId, _idBreadcrumbs, breadcrumbs) => {
    const { semanticObjectId, actionId } = common_1.getActionBreadcrumbParts(breadcrumbs);
    return `${baseId}action::${semanticObjectId}::${common_1.convertActionKeyToStableId(actionId)}`;
};
...
const getFooterActionButtonId = (baseId, _idBreadcrumbs, breadcrumbs) => {
    const { actionId } = common_1.getActionBreadcrumbParts(breadcrumbs);
    return `${baseId}action::${common_1.convertActionKeyToStableId(actionId).replace(':2f', '::')}::Determining`;
};
