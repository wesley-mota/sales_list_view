...
__decorate([
    decoration_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getTableSettingPathV2(pageKeys) + MULTIEDITPATH
        }
    })
...
__decorate([
    decoration_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys) + ux_specification_types_1.QUICKVARPATH
        }
    }),
    decoration_1.validity({
        since: '1.48.0'
...
__decorate([
    decoration_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys) + ux_specification_types_1.QUICKVARPATHX
        }
    }),
    decoration_1.validity({
        since: '1.48.0'
