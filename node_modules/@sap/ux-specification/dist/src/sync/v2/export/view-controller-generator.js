...
const renderTemplate = (templatePath, templateData) => {
    ...
    return ejs_1.render(template, templateData);
};
...
const getControllerContent = (name, namespace, fcl = false, newControllerRouting = false) => {
    ...
    return exports.renderTemplate(path_1.join(templatesPath, fcl ? 'controllerFcl.js' : 'controller.js'), templateData);
};
...
const getViewContent = (name, namespace, sourceType, controller = false, page = true) => {
    ...
    return exports.renderTemplate(path_1.join(templatesPath, 'view.' + sourceType), templateData);
};
...
const getFragmentContent = (name, namespace, sourceType, handler = false) => {
    ...
    return exports.renderTemplate(path_1.join(templatesPath, 'fragment.' + sourceType), templateData);
};
...
const getFragmentJsContent = () => {
    return exports.renderTemplate(path_1.join(templatesPath, 'fragment.js'), {});
};
...
const getSingleColumnContent = (column, template) => {
    ...
    return exports.renderTemplate(path_1.join(templatesPath, template + '.xml'), templateData);
};
