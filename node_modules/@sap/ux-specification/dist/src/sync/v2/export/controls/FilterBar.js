...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageKeys) => {
                return application_1.getAppSettingPathV2(pageKeys) + ux_specification_types_1.DATESETTINGSPATH;
            }
        }
    }),
...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingPathV2(pageKeys) + ux_specification_types_1.DATESETTINGSPATH,
...
const manifestRuleForSelectionField = {
    path: (pageKeys, _manifest, breadcrumbs) => `${application_1.getAppSettingPathV2(pageKeys)}${ux_specification_types_1.DATESETTINGSPATH}/fields/${breadcrumbs}`
};
