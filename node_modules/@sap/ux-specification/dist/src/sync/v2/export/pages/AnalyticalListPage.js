...
exports.AnalyticalListPage = void 0;
...
__decorate([
    decorators_1.syncRule({
        flex: {
            controlId: decoration_1.buildControlIdForPage,
            controlType: () => ux_specification_types_1.ControlType.DynamicPage,
            createFlexChange: decoration_1.exportToFlexChange
        }
    })
], AnalyticalListPage.prototype, "fitContent", void 0);
__decorate([
    decorators_1.childId('table')
], AnalyticalListPage.prototype, "table", void 0);
__decorate([
    decorators_1.childId('template::SmartFilterBar')
], AnalyticalListPage.prototype, "filterBar", void 0);
__decorate([
    decorators_1.childId('analyticalListPageChart')
], AnalyticalListPage.prototype, "chart", void 0);
__decorate([
    decorators_1.childId('analyticalListFooter')
], AnalyticalListPage.prototype, "footer", void 0);
AnalyticalListPage = __decorate([
    decorators_1.pageLayoutInformation({
        ...
        pageId: ux_specification_types_1.v2.FE_TEMPLATE_V2_ALP
    })
], AnalyticalListPage);
