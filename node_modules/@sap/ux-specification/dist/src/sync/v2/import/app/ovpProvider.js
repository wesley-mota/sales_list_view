...
class V2OvpProvider extends appProvider_1.AppProvider {
    constructor(importParameters) {
        ...
        common_1.transferSettingsOfObject(appSettings, importParameters.manifest, importParameters.appSchemas[schemaFile.filename]['definitions']['AppSettings'], undefined);
