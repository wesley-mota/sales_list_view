...
function generateId(page) {
    return common_2.generatePageId(common_2.getPageTypeV2(page.component.name), page.entitySet);
}
...
function getPagesAndConfigs(v2Pages, flex, manifest, schemas, fragments, logger) {
    ...
    for (const v2PageName in v2Pages) {
        ...
        const page = {
            pageType: common_2.getPageTypeV2(v2Page.component.name),
...
class V2AppProvider extends appProvider_1.AppProvider {
    constructor(importParameters) {
        ...
        common_1.transferSettingsOfObject(appSettings, importParameters.manifest, appSchema['definitions']['AppSettings'], undefined);
        // Call base
        super(importParameters.manifest, importParameters.appSchemas, generateId(v2Pages[pageKey]), getPagesAndConfigs(v2Pages, importParameters.flexChanges, importParameters.manifest, importParameters.appSchemas, importParameters.fragments, importParameters.logger), ux_specification_types_1.FioriElementsVersion.v2, appSettings);
    }
}
