...
function addSettings(importParameters, analyticalListPageConfig, factory, pageKey) {
    ...
    index_1.transferSettingsOfObject(analyticalListPageConfig.table, importParameters.manifest, schemaDefinitions[`ALP${tableType}<LineItems>`], pageKey, importParameters.logger);
    // ToolBar:
    ...
    index_1.transferSettingsOfObject(analyticalListPageConfig.table.toolBar, importParameters.manifest, schemaDefinitions[ux_specification_types_1.DefinitionName.ToolBar], pageKey, importParameters.logger);
    if (schemaDefinitions[ux_specification_types_1.DefinitionName.ActionsLR]) {
        for (const actionProperty in schemaDefinitions[ux_specification_types_1.DefinitionName.ActionsLR].properties) {
            ...
            index_1.transferSettingsOfObject(analyticalListPageConfig.table.toolBar.actions[actionKey], importParameters.manifest, schemaDefinitions[ux_specification_types_1.DefinitionName.Action], pageKey, importParameters.logger);
        }
    }
    //FilterBar:
    ...
    index_1.transferSettingsOfObject(analyticalListPageConfig.filterBar, importParameters.manifest, schemaDefinitions[ux_specification_types_1.DefinitionName.AnalyticalListPageFilterBar], pageKey, importParameters.logger);
    if (schemaDefinitions[ux_specification_types_1.DefinitionName.SelectionFields]) {
        ...
        for (const selectionProperty in schemaSelectionFields) {
            ...
            index_1.transferSettingsOfObject(analyticalListPageConfig.filterBar.selectionFields[selectionKey], importParameters.manifest, schemaDefinitions['SelectionFieldDateSettings'], pageKey, importParameters.logger, selectionKey);
        }
    }
    //Chart settings:
    ...
    index_1.transferSettingsOfObject(analyticalListPageConfig.chart, importParameters.manifest, schemaDefinitions['ChartSettings'], pageKey, importParameters.logger);
    //Footer:
    ...
    if (footerAction) {
        for (const actionProperty in footerAction.properties) {
            ...
            index_1.transferSettingsOfObject(analyticalListPageConfig.footer.actions[actionKey], importParameters.manifest, schemaDefinitions[ux_specification_types_1.DefinitionName.Action], pageKey, importParameters.logger);
        }
    }
    //KPI's:
    ...
    if (kpiCards) {
        Object.keys(kpiCards).forEach((kpiKey) => {
            ...
            index_1.transferSettingsOfObject(analyticalListPageConfig.keyPerformanceIndicators[kpiKey], importParameters.manifest, schemaDefinitions['KPISettings'], pageKey, importParameters.logger, kpiKey);
        });
    }
}
/**
...
function createAnalyticalListPageConfig(importParameters) {
    ...
    const pageKeys = [];
    const v2Page = utils_1.findAnalyticalListPage(importParameters.manifest[ux_specification_types_1.ManifestSection.generic].pages, pageKeys, importParameters.logger);
    if (!v2Page) {
        return;
    }
    ...
    index_1.addFragments(config, importParameters.manifest, v2Page, ux_specification_types_1.PageTypeV2.AnalyticalListPage, importParameters.fragments);
