...
exports.addEntityPropertiesToEnum = exports.addSelectionFields = exports.removeElementsFromEnum = exports.processMetadata = exports.addTableColumnExtensions = exports.addFragmentEnum = exports.addTabkeyEnum = exports.addListReportLeadingProperties = exports.addLineItemsType = exports.handleActionRecord = void 0;
...
function getActionId(actionType, lineItemProperties) {
    ...
    if (actionType === types_1.ActionTypeV2.ColumnIntentBased) {
        actionId = common_1.getSchemaKeyOfLineItemRecord(lineItemProperties.lineItemRecord);
    }
    else if (actionType === types_1.ActionTypeV2.ToolBarIntentBased || actionType === types_1.ActionTypeV2.FooterIntentBased) {
        actionId = common_1.prepareRef(`${lineItemProperties.lineItemRecord.SemanticObject}::${lineItemProperties.lineItemRecord.Action}`);
    }
        ...
        actionId = common_1.prepareRef(`DataFieldForAction:::sAction::${lineItemProperties.lineItemRecord.Action}`);
    }
    else {
        actionId = common_1.prepareRef(lineItemProperties.lineItemRecord.Action);
    }
...
function handleActionRecord(appSchema, actions, lineItemProps, actionType, recordIndex) {
    ...
    const { key, ns } = common_1.getActionKey(lineItemProps.lineItemRecord.Action, true);
    if (appSchema.definitions[actionReferenceType]) {
        ...
        appSchema.definitions[actionDefinition][ux_specification_types_1.SchemaTag.annotationPath] = `${lineItemProps.lineItemPath}/${recordIndex}`;
    }
}
...
function generateGenericColumn(lineItemProperties, appSchema, recordIndex) {
    const schemaKey = common_1.getSchemaKeyOfLineItemRecord(lineItemProperties.lineItemRecord);
    if (schemaKey) {
        ...
        lineItemDefinition.properties[schemaKey] = {
            ...
            description: common_1.getDataFieldDescription(lineItemProperties.lineItemRecord, lineItemProperties.entityType)
        ...
        lineItemDefinition.properties[schemaKey][ux_specification_types_1.SchemaTag.annotationPath] = `${lineItemProperties.lineItemPath}/${recordIndex}`;
        common_1.addDataTypeToDefinition(lineItemDefinition.properties[schemaKey], lineItemProperties.lineItemRecord);
        common_1.addKeyToDefinition(lineItemProperties.lineItemRecord, lineItemDefinition.properties, schemaKey);
    }
}
 ...
 */
function addTableColumnExtensions(appSchema, entityType, page, manifest, fragments, customColumnsDefinitionName = ux_specification_types_1.DefinitionName.CustomColumns, customColumnDefinitionName = ux_specification_types_1.DefinitionName.CustomColumn) {
