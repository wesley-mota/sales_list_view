...
function addEnumForVariantPaths(entityType, entitySet, appSchema, oDataServiceAVT) {
    ...
    common_1.addEnumForMultiTabVariant(appSchema, 'QuickVariantX', entitySet);
...
function generateListReportSchemaV2(generateParameters, genericSchema) {
    ...
    if (!entityType) {
        ...
        utils_1.addEntityPropertiesToEnum(appSchema.definitions.MultiEdit['properties']['ignoredFields']['items']['enum'], entityType);
        const pageKeys = [];
        const v2Page = import_1.findListReportPageV2(generateParameters.manifest[ux_specification_types_1.ManifestSection.generic].pages, pageKeys);
        if (!v2Page) {
            extensionLogger_1.log(generateParameters.logger, {
                severity: "error" /* Error */,
        ...
        common_1.addEnumFieldGroupAnnotationPath(entityType, appSchema, ux_specification_types_1.DefinitionName.MultiEditV2);
