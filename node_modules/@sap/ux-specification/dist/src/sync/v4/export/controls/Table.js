...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageName) => application_1.getSettingsPathForPage(pageName) + '/views/paths/0/primary/0',
            delete: deleteView
        }
    })
...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageName) => application_1.getSettingsPathForPage(pageName) + '/views/paths/0/secondary/0',
            delete: doNotDelete
        }
    })
...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageName) => application_1.getSettingsPathForPage(pageName) + '/views'
        }
    })
