...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageName, manifest, sectionId) => application_1.getTableSettingsPathForOP(pageName, manifest, sectionId),
            export: (manifestSection, configObject, key, manifestKey) => {
                Table_1.exportCreationModeName(manifestSection, configObject, key, manifestKey);
            },
            delete: (manifestSection, _configObject, _key, manifestKey) => {
                Table_1.deleteCreationModeName(manifestSection, manifestKey);
            }
        }
    })
...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageName, manifest, sectionId) => application_1.getTableSettingsPathForOP(pageName, manifest, sectionId),
            export: (manifestSection, configObject, key, manifestKey) => {
                Table_1.exportCreationModeCreateAtEnd(manifestSection, configObject, key, manifestKey);
            },
            delete: (manifestSection, _configObject, _key, manifestKey) => {
                Table_1.deleteCreationModeCreateAtEnd(manifestSection, manifestKey);
            }
        }
    })
...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageName, manifest, sectionId) => application_1.getTableSettingsPathForOP(pageName, manifest, sectionId) + ux_specification_types_1.QUICKVARPATH
        }
    })
