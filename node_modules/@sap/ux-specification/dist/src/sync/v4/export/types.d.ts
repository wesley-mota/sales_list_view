...
import type { ExportResults, FlexAdapter, TemplateType, PageTypeV4, ExtensionLogger, UI5Version } from '@sap/ux-specification-types';
...
export interface SyncRuleV4Section {
    flex?: FlexAdapter;
    manifest?: ManifestConverter4Section;
}
export declare type TransferParameterTypeV4 = {
