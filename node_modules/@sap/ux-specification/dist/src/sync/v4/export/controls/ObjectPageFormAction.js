...
], CustomFormActionOP.prototype, "text", void 0);
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: application_1.getActionsPathForOP
...
], CustomFormActionOP.prototype, "position", void 0);
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: application_1.getActionsPathForOP
...
], CustomFormActionOP.prototype, "visible", void 0);
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: application_1.getActionsPathForOP
...
], CustomFormActionOP.prototype, "enabled", void 0);
