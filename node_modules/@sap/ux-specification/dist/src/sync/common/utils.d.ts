 ...
 */
export declare const getManifestSectionByPathV4: (manifest: object, path: string, targetAnnotation?: string, targetAnnotationEncoded?: string) => object | undefined;
 ...
 */
export declare function generatePageId(pageType: PageTypeV2 | PageTypeV4, entitySet: string, viewId?: string): string;
