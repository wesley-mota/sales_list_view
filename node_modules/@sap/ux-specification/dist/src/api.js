...
function generateSchema(generateParameters) {
    ...
    if (generateParameters[ux_specification_types_1.FioriElementsVersion.v2]) {
        ...
        if (v4Params[ux_specification_types_1.SchemaType.ListReport]) {
            ...
            schema = generate_2.generateListReportInterfaceV4(ux_specification_types_1.TemplateType.ListReportObjectPageV4, genericSchema, entitySet, annotations, logger, manifest, contextPath);
        }
        else if (v4Params[ux_specification_types_1.SchemaType.ObjectPage]) {
            const { genericSchema, entitySet, annotations, manifest, logger, fragments, contextPath } = v4Params[ux_specification_types_1.SchemaType.ObjectPage];
            schema = generate_2.generateObjectPageInterfaceV4(genericSchema, entitySet, annotations, manifest, logger, fragments, contextPath);
        }
            ...
            schema = generate_2.generateListReportInterfaceV4(ux_specification_types_1.TemplateType.AnalyticalListPageV4, genericSchema, entitySet, annotations, logger, manifest, contextPath);
        }
            ...
            schema = generate_2.generateFPMCustomPageInterfaceV4(genericSchema, routingId, manifest, views, annotations, generateParameters.featureToggles, logger);
        }
    }
    return schema;
}
...
function importConfig(importParameters) {
    ...
    if (importParameters[ux_specification_types_1.FioriElementsVersion.v2]) {
        ...
        if (v2Params[ux_specification_types_1.SchemaType.ListReport]) {
            config = import_1.createListReportConfig(v2Params[ux_specification_types_1.SchemaType.ListReport]);
        }
        else if (v2Params[ux_specification_types_1.SchemaType.ObjectPage]) {
            config = import_1.createObjectPageConfigV2(v2Params[ux_specification_types_1.SchemaType.ObjectPage]);
        }
        else if (v2Params[ux_specification_types_1.SchemaType.OverviewPage]) {
            config = import_1.createOverviewPageConfig(v2Params[ux_specification_types_1.SchemaType.OverviewPage]);
        }
        else if (v2Params[ux_specification_types_1.SchemaType.AnalyticalListPage]) {
            config = import_1.createAnalyticalListPageConfig(v2Params[ux_specification_types_1.SchemaType.AnalyticalListPage]);
        }
    }
        ...
        if (v4Params[ux_specification_types_1.SchemaType.ListReport]) {
            config = import_2.createListReportConfig(v4Params[ux_specification_types_1.SchemaType.ListReport], ux_specification_types_1.SchemaType.ListReport);
        }
        else if (v4Params[ux_specification_types_1.SchemaType.ObjectPage]) {
            config = import_2.createObjectPageConfigV4(v4Params[ux_specification_types_1.SchemaType.ObjectPage]);
        }
        else if (v4Params[ux_specification_types_1.SchemaType.AnalyticalListPage]) {
