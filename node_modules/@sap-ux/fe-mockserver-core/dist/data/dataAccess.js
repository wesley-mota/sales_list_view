...
class DataAccess {
    ...
    async performAction(odataRequest, actionData) {
        var _a, _b;
        ...
        if (rootEntitySet) {
            ...
            if (actionName && actionName.length > 0) {
                ...
                if (collecactionDefinition) {
                    return (await this.getMockEntitySet(entitySetName)).executeAction(collecactionDefinition, actionData, odataRequest, odataRequest.queryPath[0].keys);
                }
            }
        }
        else {
    ...
    async getData(odataRequest, dontClone = false) {
        ...
        if (data !== null || (Array.isArray(data) && data.length > 0)) {
            ...
            // Apply $filter
            if ((odataRequest.filterDefinition || ((_f = odataRequest.aggregateDefinition) === null || _f === void 0 ? void 0 : _f.filter)) && Array.isArray(data)) {
                const filterDef = odataRequest.filterDefinition || ((_g = odataRequest.aggregateDefinition) === null || _g === void 0 ? void 0 : _g.filter);
            ...
            if (odataRequest.selectedProperties && Object.keys(odataRequest.selectedProperties).length > 0) {
                ...
                const expand = {
                    expand: (_h = odataRequest.expandProperties) !== null && _h !== void 0 ? _h : {},
                    properties: select
                };
                if (Array.isArray(data)) {
